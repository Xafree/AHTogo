...
export const bloc_exportation_title:string = "L'artisanal";
export const bloc_exportation_text:string = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut";

export const bloc_help_title:string = "L'aide humanitaire";
export const bloc_help_text:string = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut";
